...
class Manager:
    ...
    async def chat(self, message: str):
        ...
        if route == 'knowledge':
            ...
            personality_response = self.Personalities.apply_knwoledge_personality(message, raw_agent_response)
            ...
            personality_response = self.Personalities.apply_costumer_personality(message, raw_agent_response)
            agent_workflow.append({
            ...
            personality_response = self.Personalities.apply_pokemon_personality(message, raw_agent_response)
            agent_workflow.append({
